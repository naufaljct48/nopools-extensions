...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Doujindesu = exports.DoujindesuInfo = void 0;
...
exports.DoujindesuInfo = {
    ...
    name: 'Doujindesu',
    description: 'Extension that pulls manga from Doujindesu',
    author: 'NaufalJCT48',
    authorWebsite: 'https://github.com/naufaljct48',
    icon: 'icon.png',
    contentRating: paperback_extensions_common_1.ContentRating.MATURE,
    websiteBaseURL: DOUJINDESU_DOMAIN,
    sourceTags: [
        {
            text: 'Notifications',
...
class Doujindesu extends DoujindesuMain_1.DoujindesuMain {
    constructor() {
        //FOR ALL THE SELECTIONS, PLEASE CHECK THE MangaSteam.ts FILE!!!
        super(...arguments);
        this.baseUrl = DOUJINDESU_DOMAIN;
...
exports.Doujindesu = Doujindesu;

},{"../Doujindesu/DoujindesuMain":58,"paperback-extensions-common":14}],58:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.DoujindesuMain = exports.getExportVersion = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const DoujindesuMainParser_1 = require("../Doujindesu/DoujindesuMainParser");
...
class DoujindesuMain extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        /**
        ...
        */
        ...
        this.manga_tag_selector_box = 'div.tags';
        this.manga_tag_TraversalPathName = 'genre';
        /**
        ...
        */
        this.homescreen_PopularToday_enabled = true;
        this.homescreen_PopularToday_selector = 'h3:contains(DOUJINSHI & MANGA)';
        this.homescreen_LatestUpdate_enabled = true;
        this.homescreen_LatestUpdate_selector_box = 'h3:contains(MANHWA)';
        ...
        this.parser = new DoujindesuMainParser_1.DoujindesuMainParser();
    }
...
exports.DoujindesuMain = DoujindesuMain;

},{"../Doujindesu/DoujindesuMainParser":59,"paperback-extensions-common":14}],59:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.DoujindesuMainParser = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const LanguageUtils_1 = require("../LanguageUtils");
const entities = require("entities");
class DoujindesuMainParser {
    constructor() {
        this.parseViewMore = ($, source) => {
            ...
            for (const manga of $('article.entry', '').toArray()) {
                ...
                const subtitle = $('span:contains(Chapter)', manga).text().trim();
    ...
    parseHomeSections($, sections, sectionCallback, source) {
        ...
        for (const section of sections) {
            ...
            if (section.id == 'popular_today') {
                const popularToday = [];
                if (!$('article.entry', (_b = (_a = $(source.homescreen_PopularToday_selector)) === null || _a === void 0 ? void 0 : _a.parent()) === null || _b === void 0 ? void 0 : _b.next()).length) {
                    console.log('Unable to parse valid Popular Today section!');
                    continue;
                }
                for (const manga of $('article.entry', $(source.homescreen_PopularToday_selector).parent().next()).toArray()) {
                    const id = this.idCleaner((_c = $('a', manga).attr('href')) !== null && _c !== void 0 ? _c : '', source);
