...
exports.DoujindesuInfo = {
    ...
    name: "Doujindesu",
    description: "Extension that pulls manga from Doujindesu.xxx",
    author: "NaufalJCT48",
...
},{"../MangaStream":59,"./DoujindesuParser":57,"paperback-extensions-common":13}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.DoujindesuParser = void 0;
/* eslint-disable linebreak-style */
const MangaStreamParser_1 = require("../MangaStreamParser");
const paperback_extensions_common_1 = require("paperback-extensions-common");
class DoujindesuParser extends MangaStreamParser_1.MangaStreamParser {
    constructor() {
        super(...arguments);
    ...
    parseChapterList($, mangaId, source) {
        ...
        for (const chapter of $(source.chapter_selector_item, source.chapter_selector_box).toArray()) {
            ...
            const date = convertDate($('span.date', chapter).text().trim(), source);
...
exports.DoujindesuParser = DoujindesuParser;
