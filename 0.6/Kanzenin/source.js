...
const KanzeninParser_1 = require("./KanzeninParser");
const KANZENIN_DOMAIN = "https://kanzenin.xyz";
exports.KanzeninInfo = {
    version: (0, MangaStream_1.getExportVersion)("0.0.1"),
    name: "Kanzenin",
    description: "Extension that pulls manga from Kanzenin.xyz",
    author: "NaufalJCT48",
    authorWebsite: "http://github.com/naufaljct48",
    icon: "icon.png",
    contentRating: paperback_extensions_common_1.ContentRating.ADULT,
    websiteBaseURL: KANZENIN_DOMAIN,
    sourceTags: [
        {
            text: "Notifications",
...
class Kanzenin extends MangaStream_1.MangaStream {
    constructor() {
        ...
        super(...arguments);
        this.baseUrl = KANZENIN_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.INDONESIAN;
        this.parser = new KanzeninParser_1.KanzeninParser();
...
},{"../MangaStream":59,"./KanzeninParser":57,"paperback-extensions-common":13}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KanzeninParser = void 0;
/* eslint-disable linebreak-style */
const MangaStreamParser_1 = require("../MangaStreamParser");
const paperback_extensions_common_1 = require("paperback-extensions-common");
class KanzeninParser extends MangaStreamParser_1.MangaStreamParser {
    ...
    parseMangaDetails($, mangaId, source) {
        ...
        const author = $(`.fmed b:contains(${source.manga_selector_author})+span`).contents().last().text().trim(); //Language dependant
        const artist = $(`.fmed b:contains(${source.manga_selector_artist})+span`).contents().last().text().trim(); //Language dependant
...
exports.KanzeninParser = KanzeninParser;
