...
const MangasusuMain_1 = require("../Mangasusu/MangasusuMain");
const MANGASUSU_DOMAIN = 'https://mangasusuku.xyz';
exports.MangasusuInfo = {
    version: MangasusuMain_1.getExportVersion('0.0.0'),
    name: 'Mangasusu',
    description: 'Extension that pulls manga from Mangasusu',
    author: 'NaufalJCT48',
    authorWebsite: 'https://github.com/naufaljct48',
    icon: 'icon.png',
    contentRating: paperback_extensions_common_1.ContentRating.ADULT,
    websiteBaseURL: MANGASUSU_DOMAIN,
    sourceTags: [
        {
            text: "Notifications",
...
class Mangasusu extends MangasusuMain_1.MangasusuMain {
    constructor() {
        //FOR ALL THE SELECTIONS, PLEASE CHECK THE MangaSteam.ts FILE!!!
        super(...arguments);
        this.baseUrl = MANGASUSU_DOMAIN;
...
},{"../Mangasusu/MangasusuMain":58,"paperback-extensions-common":14}],58:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangasusuMain = exports.getExportVersion = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const MangasusuMainParser_1 = require("../Mangasusu/MangasusuMainParser");
...
class MangasusuMain extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        /**
        ...
        */
        ...
        this.parser = new MangasusuMainParser_1.MangasusuMainParser();
    }
...
exports.MangasusuMain = MangasusuMain;

},{"../Mangasusu/MangasusuMainParser":59,"paperback-extensions-common":14}],59:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangasusuMainParser = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const LanguageUtils_1 = require("../LanguageUtils");
const entities = require("entities");
class MangasusuMainParser {
    constructor() {
...
exports.MangasusuMainParser = MangasusuMainParser;
