...
const KomikIndoTopParser_1 = require("./KomikIndoTopParser");
const KOMIKINDOTOP_DOMAIN = "https://komikindo.top";
exports.KomikIndoTopInfo = {
    version: (0, MangaStream_1.getExportVersion)("0.0.1"),
    name: "KomikIndoTop",
    description: "Extension that pulls manga from KomikIndoTop.xyz",
    author: "NaufalJCT48",
    authorWebsite: "http://github.com/naufaljct48",
    icon: "icon.png",
    contentRating: paperback_extensions_common_1.ContentRating.ADULT,
    websiteBaseURL: KOMIKINDOTOP_DOMAIN,
    sourceTags: [
        {
            text: "Notifications",
...
class KomikIndoTop extends MangaStream_1.MangaStream {
    constructor() {
        ...
        super(...arguments);
        this.baseUrl = KOMIKINDOTOP_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.INDONESIAN;
        this.parser = new KomikIndoTopParser_1.KomikIndoTopParser();
...
},{"../MangaStream":59,"./KomikIndoTopParser":57,"paperback-extensions-common":13}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KomikIndoTopParser = void 0;
/* eslint-disable linebreak-style */
const MangaStreamParser_1 = require("../MangaStreamParser");
const paperback_extensions_common_1 = require("paperback-extensions-common");
class KomikIndoTopParser extends MangaStreamParser_1.MangaStreamParser {
...
exports.KomikIndoTopParser = KomikIndoTopParser;
