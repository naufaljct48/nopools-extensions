...
const MangataleMain_1 = require("../Mangatale/MangataleMain");
const MANGATALE_DOMAIN = 'https://mangatale.co';
exports.MangataleInfo = {
    version: MangataleMain_1.getExportVersion('0.0.0'),
    name: 'Mangatale',
    description: 'Extension that pulls manga from Mangatale',
    author: 'NaufalJCT48',
    authorWebsite: 'https://github.com/naufaljct48',
    icon: 'icon.png',
    contentRating: paperback_extensions_common_1.ContentRating.MATURE,
    websiteBaseURL: MANGATALE_DOMAIN,
    sourceTags: [
        {
            text: 'Notifications',
...
class Mangatale extends MangataleMain_1.MangataleMain {
    constructor() {
        //FOR ALL THE SELECTIONS, PLEASE CHECK THE MangaSteam.ts FILE!!!
        super(...arguments);
        this.baseUrl = MANGATALE_DOMAIN;
...
},{"../Mangatale/MangataleMain":58,"paperback-extensions-common":14}],58:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangataleMain = exports.getExportVersion = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const MangataleMainParser_1 = require("../Mangatale/MangataleMainParser");
...
class MangataleMain extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        /**
        ...
        */
        ...
        this.parser = new MangataleMainParser_1.MangataleMainParser();
    }
...
exports.MangataleMain = MangataleMain;

},{"../Mangatale/MangataleMainParser":59,"paperback-extensions-common":14}],59:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangataleMainParser = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const LanguageUtils_1 = require("../LanguageUtils");
const entities = require("entities");
class MangataleMainParser {
    constructor() {
...
exports.MangataleMainParser = MangataleMainParser;
