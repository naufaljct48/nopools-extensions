...
class Mangatale extends MangaStream_1.MangaStream {
    constructor() {
        ...
        this.parser = new MangataleParser_1.MangataleParser();
        this.sourceTraversalPathName = "manga";
        this.requestManager = createRequestManager({
            requestsPerSecond: 2,
            requestTimeout: 15000,
...
},{"../MangaStream":57,"./MangataleParser":60,"paperback-extensions-common":13}],60:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangataleParser = void 0;
/* eslint-disable linebreak-style */
const MangaStreamParser_1 = require("../MangaStreamParser");
const paperback_extensions_common_1 = require("paperback-extensions-common");
class MangataleParser extends MangaStreamParser_1.MangaStreamParser {
    parseChapterDetails($, mangaId, chapterId) {
        const data = $.html();
        const pages = [];
        //To avoid our regex capturing more scrips, we stop at the first match of ";", also known as the first ending the matching script.
...
exports.MangataleParser = MangataleParser;
